...
const DashboardView: React.FC<DashboardViewProps> = ({ materials, history }) => {
  // メモ化して不要な再計算を避ける
  const { totalMaterials, availableMaterials, todayActivities } = useMemo(() => {
    ...
    return { totalMaterials, availableMaterials, todayActivities };
  }, [materials, history]);
